  ...
  return (
    <>
      <div className="mt-[65px] flex flex-col md:flex-row w-full h-screen md:h-[90vh] lg:h-[85vh] bg-zinc-950 text-white">
        {/* Left Section */}
        <div className="w-full md:w-[60%] lg:w-[60%] flex flex-col justify-center animate-fadeIn border-r border-gray-600">
          {/* Text Content */}
        ...
        <div className="w-full md:w-[40%] lg:w-[40%] h-[300px] sm:h-[400px] md:h-full lg:h-full">
          <img
            // src="HeroImg.png"
            src="https://images.unsplash.com/reserve/LJIZlzHgQ7WPSh5KVTCB_Typewriter.jpg?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YmxvZ3xlbnwwfHwwfHx8MA%3D%3D"
            alt=""
