...
const BlogCard = ({ image, author, date, title, content }) => {
  return (
    <div className="animate-fadeIn w-full max-w-[380px] border border-zinc-700 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all cursor-pointer bg-zinc-950">
      {/* Image Section */}
      <div className="h-[200px] w-full">
        <img
          src={service.storage.getFilePreview(conf.appwriteBucketId, image)}
